  ...
  <div id="app">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container">
          ...
          <router-link class="my-navbar-brand" style="color: #4C4C4C;padding-top: 2%; font-family: 'Baloo Bhai', cursive;" to="/">ProteinDB</router-link>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light non-cellphone hide-item" style="display: none">
        <div class="wrap">
            <ul class="navbar-nav mr-auto" style="padding-left: 2%">
                <li class="nav-item">
