<template>
  <div>
    ...
    <div class="row">
      <div class="col-sm-12">
        <p><span style="color: white">qdnqjdwjkdnqwkdnwqdnjqwkdnqwjkdnjkqwdkwqndwqjkndjkwqndjkwqndjkqwnjkdnwqjkdnqwjkndjqwndjkwqndkjqwndjkqwndjkwnjdknwqjkdnqwjkndjqwndjwqjkdnqwjknkwdjkqwndjkwnjdknqwjk</span>
        </p>
        <p sty>
          {{question.body}}
        </p>
